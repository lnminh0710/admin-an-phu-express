          ...
          <Card>
                ...
                <Row>
                  <Col md={5} xs={9}>
                    ...
                    <p className="text-muted mb-0">
                      <i className="mdi mdi-circle text-success align-middle me-1"></i> Active now
                    </p>
                  </Col>
                  <Col md={7} xs={3}>
                        ...
                        <div className="conversation-list">
                          ...
                          <div className="ctext-wrap">
                            ...
                            <p className="chat-time mb-0">
                              <i className="mdi mdi-clock-outline align-middle me-1"></i> 12:09
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li className="right">
                        <div className="conversation-list">
                          <div className="ctext-wrap">
                            ...
                            <div className="ctext-wrap-content">
                              <p className="mb-0">Hi, How are you? What about our next meeting?</p>
                            </div>

                            <p className="chat-time mb-0">
                              <i className="bx bx-time-five align-middle me-1"></i> 10:02
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li>
                        <div className="conversation-list">
                          ...
                          <div className="ctext-wrap">
                            ...
                            <p className="chat-time mb-0">
                              <i className="mdi mdi-clock-outline align-middle me-1"></i> 10:00
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li>
                        <div className="conversation-list">
                          ...
                          <div className="ctext-wrap">
                            ...
                            <p className="chat-time mb-0">
                              <i className="bx bx-time-five align-middle me-1"></i> 10:06
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li className="right">
                        <div className="conversation-list">
                          <div className="ctext-wrap">
                            ...
                            <p className="chat-time mb-0">
                              <i className="bx bx-time-five align-middle me-1"></i> 10:07
                            </p>
                          </div>
                        </div>
                      </li>
            ...
            <div className="p-3 chat-input-section border-top">
              <Row>
                ...
                <Col xs={{ size: 'auto' }}>
                  <Button color="primary" type="submit" className="chat-send w-md waves-effect waves-light">
