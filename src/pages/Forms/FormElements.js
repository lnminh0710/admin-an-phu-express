              ...
              <Col xs={12}>
                <Card>
                  <CardBody>
                    ...
                    <Row className="mb-3">
                      <Label htmlFor="example-url-input" className="col-md-2 col-form-label">
                        URL
                      </Label>
                      <Col md={10}>
                    ...
                    <Row className="mb-3">
                      <Label htmlFor="example-datetime-local-input" className="col-md-2 col-form-label">
                        Date and time
                      </Label>
                      <Col md={10}>
                    ...
                    <Row className="mb-3">
                      <Label htmlFor="example-month-input" className="col-md-2 col-form-label">
                        Month
                      </Label>
                      <Col md={10}>
                    ...
                    <Row className="mb-3">
                      <Label htmlFor="example-week-input" className="col-md-2 col-form-label">
                        Week
                      </Label>
                      <Col md={10}>
                    ...
                    <Row className="mb-3">
                      <Label htmlFor="example-time-input" className="col-md-2 col-form-label">
                        Time
                      </Label>
                      <Col md={10}>
                    ...
                    <Row className="mb-3">
                      <Label htmlFor="example-color-input" className="col-md-2 col-form-label">
                        Color
                      </Label>
                      <Col md={10}>
                        <Input
              ...
              <Col lg={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Set heights using classNames like <code>.form-control-lg</code> and <code>.form-control-sm</code>.
                    </p>
                    <div>
                      <div className="mb-4">
              ...
              <Col lg={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      A switch has the markup of a custom checkbox but uses the <code>.custom-switch</code> className to render a toggle switch.
