...
class FormMask extends Component {
  ...
  render() {
    ...
    const IPV4 = props => (
      <InputMask mask="999.999.999.999" value={props.value} className="form-control input-color" onChange={props.onChange}>
        {inputProps => <MaterialInput {...inputProps} type="tel" disableUnderline />}
      </InputMask>
    );

    const IPV6 = props => (
      <InputMask mask="****:****:****:*:***:****:****:****" value={props.value} className="form-control input-color" onChange={props.onChange}>
    ...
    const Phone = props => (
      <InputMask mask="(999) 999-9999" value={props.value} className="form-control input-color" onChange={props.onChange}>
        {inputProps => <MaterialInput {...inputProps} type="tel" disableUnderline />}
      </InputMask>
    );
                    ...
                    <Row>
                      <Col md="6">
                        <div className="p-20">
                          <Form action="#">
                            <div className="mb-3">
                              <Label className="form-label">ISBN 1</Label>
                              <ISBN1 />
                              <span className="font-13 text-muted">e.g "999-99-999-9999-9"</span>
                            </div>
                            <div className="mb-3">
                              <Label className="form-label">ISBN 2</Label>
                              <ISBN2 />
                              <span className="font-13 text-muted">999 99 999 9999 9</span>
                            </div>
                            <div className="mb-3">
                              <Label className="form-label">ISBN 3</Label>
                              <ISBN3 />
                              <span className="font-13 text-muted">999/99/999/9999/9</span>
                            </div>
                            <div className="mb-3">
