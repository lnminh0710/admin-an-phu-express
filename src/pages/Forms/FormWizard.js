                          ...
                          <div>
                            <Form>
                              ...
                              <Row>
                                ...
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-declaration-input10">
                                      Declaration
                                    </Label>
                          ...
                          <div>
                            <Form>
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-namecard-input11">
                                      Name on Card
                                    </Label>
                              ...
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-cardno-input12">
                                      Credit Card Number
                                    </Label>
                                ...
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-card-verification-input">
                              ...
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-expiration-input13">
                                      Expiration Date
                                    </Label>
                  ...
                  <CardBody>
                    ...
                    <div id="progrss-wizard" className="twitter-bs-wizard">
                        ...
                        <TabPane tabId={1}>
                          <Form>
                            <Row>
                              <Col lg="6">
                                <div className="mb-3">
                                  <Label className="form-label" htmlFor="basicpill-firstname-input14">
                                    First name
                                  </Label>
                              ...
                              <Col lg="6">
                                <div className="mb-3">
                                  <Label className="form-label" htmlFor="basicpill-lastname-input15">
                                    Last name
                                  </Label>
                            ...
                            <Row>
                              <Col lg="6">
                                <div className="mb-3">
                                  <Label className="form-label" htmlFor="basicpill-phoneno-input16">
                                    Phone
                                  </Label>
                              ...
                              <Col lg="6">
                                <div className="mb-3">
                                  <Label className="form-label" htmlFor="basicpill-email-input17">
                                    Email
                                  </Label>
                          ...
                          <div>
                            <Form>
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-pancard-input18">
                                      PAN Card
                                    </Label>
                                ...
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-vatno-input19">
                                      VAT/TIN No.
                                    </Label>
                              ...
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-cstno-input20">
                                      CST No.
                                    </Label>
                                ...
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-servicetax-input21">
                                      Service Tax No.
                                    </Label>
                              ...
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-companyuin-input22">
                                      Company UIN
                                    </Label>
                                ...
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-declaration-input23">
                                      Declaration
                                    </Label>
                          ...
                          <div>
                            <Form>
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-namecard-input24">
                                      Name on Card
                                    </Label>
                              ...
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-cardno-input25">
                                      Credit Card Number
                                    </Label>
                                ...
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-card-verification-input26">
                                      Card Verification Number
                                    </Label>
                              ...
                              <Row>
                                <Col lg="6">
                                  <div className="mb-3">
                                    <Label className="form-label" htmlFor="basicpill-expiration-input27">
                                      Expiration Date
                                    </Label>
                      ...
                      <ul className="pager wizard twitter-bs-wizard-pager-link">
                        ...
                        <li className={this.state.activeTabProgress === 4 ? 'next disabled' : 'next'}>
                          <Link
                            to="#"
                            onClick={() => {
                              this.toggleTabProgress(this.state.activeTabProgress + 1);
