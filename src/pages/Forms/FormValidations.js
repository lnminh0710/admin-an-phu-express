...
class FormValidations extends Component {
  ...
  changeHandeler(event, eleId) {
    if (event.target.value !== '') document.getElementById(eleId).style.display = 'none';
              ...
              <Col xl="6">
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      If your form layout allows it, you can swap the <code>.-feedback</code> classes for <code>.-tooltip</code> classes to
              ...
              <Col lg={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Parsley is a availity reactstrap validation. It helps you provide your users with feedback on their form submission before
