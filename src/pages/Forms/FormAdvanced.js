                    ...
                    <Form action="#">
                      ...
                      <div className="mb-3">
                        ...
                        {this.state.display_RGBA ? (
                          <SketchPicker color="#fff" value={this.state.colorRGBA} width="160px" onChangeComplete={this.onSwatchHover_RGBA} />
                        ) : null}
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        {this.state.simple_color2 ? (
                          <SketchPicker color="#fff" value={this.state.simple_color2} width="160px" onChangeComplete={this.handleHor} />
                        ) : null}
                      </div>
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      This plugin integrates by default with Twitter bootstrap using badges to display the maximum lenght of the field where the
                      user is inserting text.{' '}
                    </p>
                    <Label className="form-label">Default usage</Label>
                    <p className="text-muted m-b-15">The badge will show up by default when the remaining chars are 10 or less:</p>
                    ...
                    <div className="mt-3">
                      ...
                      <Input
                        ...
                        id="thresholdconfig"
                      />
                      {this.state.disthresh ? <span className="badgecount badge badge-info">{this.state.threshholdcount} / 25 </span> : null}
                    </div>
                    ...
                    <div className="mt-3">
                      ...
                      <p className="text-muted m-b-15">
                        All you need to do is specify the <code>placement</code> option, with one of those strings. If none is specified, the
                    ...
                    <div className="mt-3">
                      ...
                      <p className="text-muted m-b-15">Bootstrap maxlength supports textarea as well as inputs. Even on old IE.</p>
                      <Input
                        type="textarea"
                        id="textarea"
                      ...
                      />
                      {this.state.textareabadge ? <span className="badgecount badge badge-info"> {this.state.textcount} / 225 </span> : null}
                    </div>
                  </CardBody>
                </Card>
              </Col>
                    ...
                    <Form>
                      <FormGroup className="mb-3">
                        ...
                        <InputGroup>
                          ...
                          <input type="number" className="form-control" value={this.state.data_attr} placeholder="number" readOnly />
                          <div
                            className="input-group-append"
                            onClick={() =>
                              this.setState({
                      ...
                      <FormGroup className="mb-3">
                        ...
                        <InputGroup>
                          <span
                            ...
                            onClick={() => this.setState({ postfix: this.state.postfix - 1 })}
                          >
                            <Button type="button" color="primary">
                              <i className="mdi mdi-minus" />
                            </Button>
                          </span>
                          <input type="number" className="form-control" value={this.state.postfix} placeholder="number" readOnly />
                      ...
                      <FormGroup className="mb-3">
                        ...
                        <InputGroup>
                          <span
                            className="input-group-btn input-group-prepend"
                            onClick={() => this.setState({ postfix1: this.state.postfix1 - 1 })}
                          >
                            <Button type="button" color="primary">
                              <i className="mdi mdi-minus" />
                            </Button>
                          ...
                          <input type="number" className="form-control" value={this.state.postfix1} placeholder="number" readOnly />
                      ...
                      <FormGroup className="mb-3">
                        ...
                        <InputGroup>
                          ...
                          <input type="number" className="form-control" value={this.state.empty_val} placeholder="number" readOnly />
                          <span
                            className="input-group-append"
                            onClick={() =>
                              this.setState({
                      ...
                      <FormGroup className="mb-3">
                        ...
                        <InputGroup>
                          ...
                          <input type="number" className="form-control" value={this.state.not_attr} placeholder="number" readOnly />
                          <div
                            className="input-group-append"
                            onClick={() =>
                              this.setState({
                      ...
                      <FormGroup className="mb-0">
                        ...
                        <InputGroup>
                          ...
                          <input type="number" className="form-control" value={this.state.explicit_val} placeholder="number" readOnly />
                          <div
                            className="input-group-append"
                            onClick={() =>
                              this.setState({
                      ...
                      <Col lg="6">
                        ...
                        <div>
                          ...
                          <Switch
                            ...
                            className="me-1 mb-sm-8 mb-2"
                            onColor="#02a499"
                            onChange={() => this.setState({ switch3: !this.state.switch3 })}
                          ...
                          <Switch
                            ...
                            checkedIcon={<OnSymbol />}
                            onColor="#626ed4"
                            onChange={() => this.setState({ switch4: !this.state.switch4 })}
                          ...
                          <Switch
                            ...
                            checkedIcon={<OnSymbol />}
                            onColor="#02a499"
                            onChange={() => this.setState({ switch5: !this.state.switch5 })}
                          ...
                          <Switch
                            ...
                            checkedIcon={<OnSymbol />}
                            onColor="#38a4f8"
                            onChange={() => this.setState({ switch6: !this.state.switch6 })}
                          ...
                          <Switch
                            ...
                            className="me-1 mb-sm-8 mb-2"
                            onColor="#f8b425"
                            onChange={() => this.setState({ switch7: !this.state.switch7 })}
                          ...
                          <Switch
                            ...
                            className="me-1 mb-sm-8 mb-2"
                            onColor="#ec4561"
                            onChange={() => this.setState({ switch8: !this.state.switch8 })}
                          ...
                          <Switch
                            ...
                            className="me-1 mb-sm-8 mb-2"
                            onColor="#2a3142"
                            onChange={() => this.setState({ switch9: !this.state.switch9 })}
                        ...
                        <div className="mt-4 mt-lg-0">
                          ...
                          <div className="d-flex">
                            ...
                            <div className="square-switch">
                              ...
                              />
                              <label htmlFor="square-switch2" data-on-label="Yes" data-off-label="No" />
                            </div>
                            <div className="square-switch">
                              <input
                                type="checkbox"
                              ...
                              />
                              <label htmlFor="square-switch3" data-on-label="Yes" data-off-label="No" />
                            </div>
                          </div>
                        </div>
                      </Col>
