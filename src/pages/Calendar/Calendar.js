...
class Calender extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <DeleteModal show={deleteModal} onDeleteClick={this.handleDeleteEvent} onCloseClick={() => this.setState({ deleteModal: false })} />
              ...
              <Col className="col-12">
                <Card>
                  <CardBody>
                    <Row>
                      <Col lg={3}>
                        <Button color="primary" className="font-16 btn-block btn btn-primary" onClick={this.togglecategory}>
