                  ...
                  <CardBody>
                    <div id="checkout-nav-pills-wizard" className="twitter-bs-wizard">
                      ...
                      <TabContent activeTab={this.state.activeTab} className="twitter-bs-wizard-tab-content">
                        <TabPane tabId={1}>
                          <CardTitle className="h5">Billing information</CardTitle>
                            ...
                            <div>
                              <div>
                                <Row>
                                  ...
                                  <Col lg={4}>
                                    <div className="mb-4">
                                      <Label htmlFor="billing-email-address" className="form-label">
                                        Email Address
                                      </Label>
                                ...
                                <div className="mb-4">
                                  <Label htmlFor="billing-address" md="2" className="form-label">
                                    Address
                                  </Label>
                                ...
                                <Row>
                                  <Col lg={4}>
                                    <div className="mb-4 mb-lg-0">
                                      ...
                                      <select className="form-select select2" title="Country">
                                  ...
                                  <Col lg={4}>
                                    <div className="mb-4 mb-lg-0">
                                      <Label className="form-label" for="billing-city">
                                        City
                                      </Label>
                        ...
                        <TabPane tabId={3} id="v-pills-confir" role="tabpanel">
                          ...
                          <div>
                            ...
                            <div className="p-4 border">
                              <form>
                                <div className="mb-3">
                                  <Label className="form-label" for="cardnameInput">
                                    Name on card
                                  </Label>
                                ...
                                <div className="row">
                                  <Col lg={4} sm={6}>
                                    <div className="mb-3 mb-lg-0">
                                      <Label className="form-label" for="cardnumberInput">
                                        Card Number
                                      </Label>
                                  ...
                                  <Col lg={4} sm={6}>
                                    <div className="mb-3 mb-lg-0">
                                      <Label className="form-label" for="expirydateInput">
                                        Expiry date
                                      </Label>
                                  ...
                                  <Col lg={4} sm={6}>
                                    <div className="mb-3 mb-lg-0">
                                      <Label className="form-label" for="cvvcodeInput">
                                        CVV Code
                                      </Label>
                  ...
                  <CardBody>
                    <div className="p-3 bg-light mb-4">
                      <h5 className="font-size-14 mb-0">
                        Order Summary <span className="float-end ms-2">#SK2356</span>
                      </h5>
                    </div>
                            ...
                            <tr key={'_orderSummary_' + key}>
                              ...
                              <td>
                                <h5 className="font-size-14 text-truncate">
                                  <Link to="/ecommerce-product-details/1" className="text-dark">
                            ...
                            <td colSpan="3">
                              <div className="bg-soft-primary p-3 rounded">
                                <h5 className="font-size-14 text-primary mb-0">
                                  <i className="fas fa-shipping-fast me-2" /> Shipping <span className="float-end">Free</span>
                                </h5>
                              </div>
                            </td>
                          </tr>
