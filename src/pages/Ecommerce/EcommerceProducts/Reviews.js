      ...
      <div className="border p-4 rounded">
        {map(comments, (comment, k) => (
          <React.Fragment key={'review_' + k}>
            <div className={comment.id === 1 ? 'd-flex border-bottom pb-3' : 'd-flex border-bottom py-3'}>
              <div className="flex-1">
                ...
                <ul className="list-inline product-review-link mb-0">
                  <li className="list-inline-item">
                    <Link to="#">
                      <i className="mdi mdi-thumb-up align-middle me-1"></i> Like
                    </Link>
                  </li>{' '}
                  <li className="list-inline-item">
                    <Link to="#">
                      <i className="mdi mdi-message-text align-middle me-1"></i> Comment
                    </Link>
                  </li>
                </ul>
              </div>
