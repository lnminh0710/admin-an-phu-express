    ...
    this.setState(
      {
        filters: {
          ...filters,
          discount: discount.find(item => item === value) ? discount.filter(item => item !== value) : [...discount, value],
        },
      },
      () => {
                ...
                <Card>
                  ...
                  <CardBody className="border-top">
                    <div>
                      ...
                      <br />
                      <Nouislider range={{ min: 0, max: 600 }} tooltips={true} start={[100, 500]} connect onSlide={this.state.onUpdate} />
                    </div>
                  </CardBody>
                  ...
                  <div className="custom-accordion">
                    <CardBody className="border-top">
                      <div>
                        <h5 className="font-size-14 mb-0">
                          <Link to="#" onClick={this.filterdiscountstoggle} className="text-dark d-block" data-bs-toggle="collapse">
                    ...
                    <CardBody class="border-top">
                      <div>
                        <h5 class="font-size-14 mb-0">
                          <Link to="#" class="text-dark d-block" data-bs-toggle="collapse" onClick={this.filtersizetoggle}>
                            Size <i class="mdi mdi-minus float-end accor-plus-icon"></i>
                          </Link>
                        </h5>

                        <Collapse isOpen={this.isFilterProductSizeOpen} id="filterprodductcolor-collapse" data-bs-toggle="collapse">
                          <div class="mt-4">
                            <div class="form-check mt-2">
                              <Input type="checkbox" value="x-large" className="form-check-input" id="productsizeRadio1" />
                              <Label className="form-check-label" htmlFor="productsizeRadio1">
                                X-Large
                              </Label>
                            </div>
                            <div class="form-check mt-2">
                              <Input type="checkbox" value="x-large" className="form-check-input" id="productsizeRadio2" />
                              <Label className="form-check-label" htmlFor="productsizeRadio2">
                                Large
                              </Label>
                            </div>
                            <div class="form-check mt-2">
                              <Input type="checkbox" value="x-large" className="form-check-input" id="productsizeRadio3" />
                              <Label className="form-check-label" htmlFor="productsizeRadio3">
                                Medium
                              </Label>
                            </div>
                            <div class="form-check mt-2">
                              <Input type="checkbox" value="x-large" className="form-check-input" id="productsizeRadio4" />
                    ...
                    <CardBody className="border-top">
                      <div>
                        ...
                        <Collapse isOpen={this.isFilterProductRatingOpen} id="filterprodductcolor-collapse" data-bs-toggle="collapse">
                          <div className="mt-4">
                        ...
                        {!isEmpty(products) &&
                          products.map((product, key) => (
                            <Col xl="4" sm="6" key={'_col_' + key}>
                              <div className="product-box" onClick={() => history.push(`/ecommerce-product-detail/${product.id}`)}>
                                <div className="product-img">
                                  {product.islable ? <div className="product-ribbon badge bg-warning">{product.lable}</div> : null}
                                  {product.isOffer ? <div className="product-ribbon badge bg-danger">{`-${product.offer}%`}</div> : null}
                                ...
                                <div className="text-center">
                                  <p className="text-muted font-size-13">{product.extrades}</p>
