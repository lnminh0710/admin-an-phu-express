...
import { Button, Card, CardBody, Col, Container, Nav, NavItem, NavLink, Row, TabContent, Input, TabPane, Table } from 'reactstrap';
                                  ...
                                  <ul className="list-unstyled product-desc-list">
                                    {product.shortservices &&
                                      product.shortservices.map((item, i) => (
                                        <li key={i}>
                                          <i className={'mdi ' + item.icon + ' text-primary me-1 font-size-16'}></i> {item.value}
                                        </li>
                                      ))}
                                  </ul>
                                </Col>
                            ...
                            <TabContent activeTab={this.state.activeDescriptionTab} className="border border-top-0 p-4">
                              <TabPane tabId="description">
                                <div>
                                  ...
                                  <p>
                                    To achieve this, it would be necessary to have uniform grammar, pronunciation and more common several
                                  ...
                                  <div>
                                    <p className="mb-2">
                                      <i className="mdi mdi-circle-medium me-1 align-middle"></i> If several languages coalesce
                                    </p>
                                    <p className="mb-2">
                                      <i className="mdi mdi-circle-medium me-1 align-middle"></i> To an English person, it will seem like
                                      simplified
                                    </p>
                                    <p className="mb-0">
                                      <i className="mdi mdi-circle-medium me-1 align-middle"></i> These cases are perfectly simple.
                                    </p>
                                  </div>
                                </div>
                              </TabPane>
