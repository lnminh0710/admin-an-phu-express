              ...
              <div className="chat-leftsidebar">
                <div className="p-3 border-bottom">
                  <div className="d-flex">
                    ...
                    <div>
                      <Dropdown isOpen={this.state.notification_Menu} toggle={this.toggleNotification} className="chat-noti-dropdown">
                          ...
                          groups.map(group => (
                            <li key={'test' + group.image}>
                              <Link
                                to="#"
                                onClick={() => {
                                  this.userChatOpen(group.id, group.name, group.status, Math.floor(Math.random() * 100));
                                }}
                              >
                                <div className="d-flex align-items-center">
                                  <div className="avatar-xs me-3">
                                    <span className="avatar-title rounded-circle bg-light text-body">{group.image}</span>
                                  </div>
                                ...
                                {contact.child.map(array => (
                                  <li key={'test' + array.id}>
                                    <Link
                                      to="#"
                                      onClick={() => {
                                        this.userChatOpen(array.id, array.name, array.status, Math.floor(Math.random() * 100));
                                      }}
                                    >
                    ...
                    <ul className="list-unstyled mb-0 pe-3">
                      <PerfectScrollbar style={{ maxHeight: '450px' }}>
                        {messages.map((message, key) => (
                          <li key={key} className={message.sender === currentUser.name ? 'right' : ''} style={{ paddingRight: '20px' }}>
