...
import { Sparklines, SparklinesLine, SparklinesBars, SparklinesSpots, SparklinesReferenceLine, SparklinesCurve } from 'react-sparklines';
              ...
              <Col sm={4}>
                <Card>
                  <CardBody>
                    ...
                    <Sparklines height={100} data={[5, 10, 5, 20, 18, 17, 29, 10, 18]}>
                      <SparklinesLine
                        style={{
                          strokeWidth: 0.8,
                          stroke: '#6d60b0',
