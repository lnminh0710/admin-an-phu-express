        ...
        <div className="page-content">
          <Container fluid>
            ...
            {this.state.success_dlg ? (
              <SweetAlert success title={this.state.dynamic_title} onConfirm={() => this.setState({ success_dlg: false })}>
                {this.state.dynamic_description}
              </SweetAlert>
            ) : null}

            {this.state.error_dlg ? (
              <SweetAlert error title={this.state.dynamic_title} onConfirm={() => this.setState({ error_dlg: false })}>
                {this.state.dynamic_description}
              </SweetAlert>
            ) : null}
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      A beautiful, responsive, customizable and accessible (WAI-ARIA) replacement for JavaScript's popup boxes. Zero
                      dependencies.
                    </p>
                    ...
                    <Row className="text-center">
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.basic ? (
                          <SweetAlert title="Any fool can use a computer" onConfirm={() => this.setState({ basic: false })}></SweetAlert>
                        ) : null}
                      </Col>
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        <div className="p-3">
                        ...
                        {this.state.with_title ? (
                          <SweetAlert title="The Internet?" warning onConfirm={() => this.setState({ with_title: false })}>
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        <div className="p-3">
                          ...
                          <Button
                            onClick={() => this.setState({ alert_confirm: true })}
                            type="button"
                            color="primary"
                            className=" waves-effect waves-light"
                            id="sa-warning"
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.img_header ? (
                          <SweetAlert title="Sweet!" custom customIcon={logodark} onConfirm={() => this.setState({ img_header: false })}>
                          ...
                          <SweetAlert
                            ...
                            onConfirm={() =>
                              this.setState({
                                ...
                                dynamic_description: 'Submitted email : ' + this.state.emailtxt,
                              })
                            }
                            onCancel={() => this.setState({ ajax_div: false })}
                          >
                            <input type="email" className="form-control" placeholder="Enter Email" id="ajaxemail" onChange={this.saveEmail} />
                          </SweetAlert>
                        ) : null}
                      </Col>
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.final_step ? (
                          <SweetAlert title="All done!" confirmBtnText="Lovely!" onConfirm={() => this.setState({ final_step: false })}>
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.final_queue ? (
                          <SweetAlert confirmBtnText="OK" title="" onConfirm={() => this.setState({ final_queue: false })}>
