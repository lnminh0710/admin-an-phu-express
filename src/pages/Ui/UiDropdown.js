                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Any single <code className="highlighter-rouge">.btn</code> can be turned into a dropdown toggle with some markup changes.
                      Here’s how you can put them to work with either <code className="highlighter-rouge">&lt;button&gt;</code> elements:
                    </p>
                    <Row>
                      <Col sm={6}>
                        <Dropdown isOpen={this.state.singlebtn} toggle={() => this.setState({ singlebtn: !this.state.singlebtn })}>
                      ...
                      <Col sm={6}>
                        <Dropdown
                          ...
                          toggle={() => this.setState({ singlebtn1: !this.state.singlebtn1 })}
                  ...
                  <CardBody>
                    ...
                    <div className="">
                      <ButtonGroup className="me-1 mt-2">
                        <Dropdown isOpen={this.state.btnprimary1} toggle={() => this.setState({ btnprimary1: !this.state.btnprimary1 })}>
                      ...
                      &nbsp;
                      <ButtonGroup className="me-1 mt-2">
                        <Dropdown isOpen={this.state.btnlight1} toggle={() => this.setState({ btnlight1: !this.state.btnlight1 })}>
                      ...
                      &nbsp;
                      <ButtonGroup className="me-1 mt-2">
                        <Dropdown isOpen={this.state.btnsuccess1} toggle={() => this.setState({ btnsuccess1: !this.state.btnsuccess1 })}>
                      ...
                      <ButtonGroup className="me-1 mt-2">
                        <Dropdown isOpen={this.state.btnInfo1} toggle={() => this.setState({ btnInfo1: !this.state.btnInfo1 })}>
                      ...
                      <ButtonGroup className="me-1 mt-2">
                        <Dropdown isOpen={this.state.btnWarning1} toggle={() => this.setState({ btnWarning1: !this.state.btnWarning1 })}>
                      ...
                      &nbsp;
                      <ButtonGroup className="me-1 mt-2">
                        <Dropdown isOpen={this.state.btnDanger1} toggle={() => this.setState({ btnDanger1: !this.state.btnDanger1 })}>
              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Trigger dropdown menus above elements by adding <code className="highlighter-rouge">.dropup</code> to the parent element.
                    </p>
                    <div className="d-flex">
                      <Dropdown isOpen={this.state.dropup1} direction="up" toggle={() => this.setState({ dropup1: !this.state.dropup1 })}>
              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Add <code className="highlighter-rouge">.dropdown-menu-right</code> to a{' '}
                      <code className="highlighter-rouge">.dropdown-menu</code> to right align the dropdown menu.
                    </p>
                    <ButtonDropdown
                      isOpen={this.state.drop_align}
                      direction="right"
                      toggle={() => this.setState({ drop_align: !this.state.drop_align })}
                    >
