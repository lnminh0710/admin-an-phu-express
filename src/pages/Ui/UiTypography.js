                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      ...
                      <code className="highlighter-rouge">&lt;h6&gt;</code>, are available.
                    </p>

                    <h1 className="mb-3">
                      h1. Bootstrap heading <small className="text-muted">Semibold 2.0325rem (32.52px)</small>
                    </h1>
                    <h2 className="mb-3">
                      h2. Bootstrap heading <small className="text-muted">Semibold 1.626rem (26.016px)</small>
                    </h2>
                    <h3 className="mb-3">
                      h3. Bootstrap heading <small className="text-muted">Semibold 1.42275rem (22.764px)</small>
                    </h3>
                    <h4 className="mb-3">
                      h4. Bootstrap heading <small className="text-muted">Semibold 1.2195rem (19.512px)</small>
                    </h4>
                    <h5 className="mb-3">
                      h5. Bootstrap heading <small className="text-muted">Semibold 1.01625rem (16.26px)</small>
                    </h5>
                    <h6 className="mb-3">
                      h6. Bootstrap heading <small className="text-muted">Semibold 0.813rem (13.008px)</small>
                    </h6>
                  </CardBody>
                </Card>
              </Col>
              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Remove the default <code className="highlighter-rouge">list-style</code> and left margin on list items (immediate children
                      only). <strong>This only applies to immediate children list items</strong>, meaning you will need to add the class for any
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Remove a list’s bullets and apply some light <code className="highlighter-rouge">margin</code> with a combination of two
                      classes, <code className="highlighter-rouge">.list-inline</code> and
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      ...
                      <code className="highlighter-rouge">&lt;blockquote className="blockquote"&gt;</code> around any{' '}
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      ...
                      terms, you can optionally add a <code className="highlighter-rouge">.text-truncate</code> class to truncate the text with
                      an ellipsis.
                    </p>
