              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Add labels to your progress bars by placing text within the <code className="highlighter-rouge">.progress-bar</code>.
                    </p>
              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <div className="">
                      <Progress className="mb-3" value={25} color="primary" style={{ height: '3px' }}></Progress>
                      <Progress value={25} color="primary" style={{ height: '24px' }}></Progress>
                    </div>
                  </CardBody>
                </Card>
              </Col>
              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      The striped gradient can also be animated. Add <code className="highlighter-rouge"> striped animated </code> to to animate
              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Add <code className="highlighter-rouge"> striped </code> to any to apply a stripe via CSS gradient over the progress bar’s
                      background color.
                    </p>
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc mb-5">
                      Add <code className="highlighter-rounge">.animated-progess</code> class with{' '}
                      <code className="highlighter-rounge">.progress-bar</code> for animated progressbar.
                    </p>
