                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      ...
                      <code className="highlighter-rouge">bootstrap.js</code> file—to extend our navigational tabs and pills to create tabbable
                      ...
                      <Col md={9}>
                        <TabContent activeTab={this.state.customActiveTab} className="text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                          <TabPane tabId="1" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            ...
                            <p>
                              Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex
                              squid.
                            </p>
                          </TabPane>
                          <TabPane tabId="2" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            ...
                            <p className="mb-0">
                              {' '}
                              Qui photo booth letterpress, commodo enim craft beer mlkshk aliquip jean shorts ullamco ad vinyl cillum PBR. Homo
                              nostrud organic, assumenda labore aesthetic magna 8-bit
                            </p>
                          </TabPane>
                          <TabPane tabId="3" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                            ...
                            <p className="mb-0">
                              DIY synth PBR banksy irony. Leggings gentrify squid 8-bit cred pitchfork. Williamsburg banh mi whatever
                              gluten-free.
                            </p>
                          </TabPane>
                          <TabPane tabId="4" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                            <p>
                              Trust fund seitan letterpress, keytar raw denim keffiyeh etsy art party before they sold out master cleanse
                              gluten-free squid scenester freegan cosby sweater. Fanny pack portland seitan DIY, art party locavore wolf cliche
                              high life echo park Austin. Cred vinyl keffiyeh DIY salvia PBR, banh mi before they sold out farm-to-table.
                            </p>
                            <p className="mb-0">
                              Fanny pack portland seitan DIY, art party locavore wolf cliche high life echo park Austin. Cred vinyl keffiyeh DIY
              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      You can use a link with the <code className="highlighter-rouge">href</code> attribute, or a button with the{' '}
                      <code className="highlighter-rouge">data-target</code> attribute. In both cases, the{' '}
                      <code className="highlighter-rouge"> data-toggle="collapse"</code> is required.
                    </p>

                    <p>
                      <Link to="#" onClick={this.t_col5} style={{ cursor: 'pointer' }} className="btn btn-primary mo-mb-2">
                        Link with href{' '}
                      </Link>{' '}
                      &nbsp;
                      <button onClick={this.t_col5} className="btn btn-primary mo-mb-2" type="button" style={{ cursor: 'pointer' }}>
                        ...
                        <Link to="#" onClick={this.t_col1} style={{ cursor: 'pointer' }} className="text-dark">
                          <CardHeader id="headingOne">
                            <h6 className="m-0 font-14">
                              ...
                              <i
                                className={
                                  this.state.col1 ? 'mdi mdi-minus float-end accor-plus-icon' : 'mdi mdi-plus float-end accor-plus-icon'
                                }
                              ></i>
                            </h6>
                          </CardHeader>
                        ...
                        <Link to="#" onClick={this.t_col2} style={{ cursor: 'pointer' }} className="text-dark">
                          <CardHeader id="headingTwo">
                            <h6 className="m-0 font-14">
                              ...
                              <i
                                className={
                                  this.state.col2 ? 'mdi mdi-minus float-end accor-plus-icon' : 'mdi mdi-plus float-end accor-plus-icon'
                                }
                              ></i>
                            </h6>
                          </CardHeader>
                        ...
                        <Link to="#" onClick={this.t_col3} style={{ cursor: 'pointer' }} className="text-dark">
                          <CardHeader id="headingThree">
                            <h6 className="m-0 font-14">
                              ...
                              <i
                                className={
                                  this.state.col3 ? 'mdi mdi-minus float-end accor-plus-icon' : 'mdi mdi-plus float-end accor-plus-icon'
                                }
                              ></i>
                            </h6>
                          </CardHeader>
