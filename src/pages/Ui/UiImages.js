              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Use classNames <code>.rounded</code> and <code>.rounded-circle</code>.
                    </p>
                    <Row>
                      <Col md={6}>
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      In addition to our border-radius utilities, you can use <code className="highlighter-rouge">.img-thumbnail</code> to give
              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Images in Bootstrap are made responsive with <code className="highlighter-rouge">.img-fluid</code>.{' '}
                      <code className="highlighter-rouge">max-width: 100%;</code> and <code className="highlighter-rouge">height: auto;</code>{' '}
