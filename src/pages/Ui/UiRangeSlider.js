                    ...
                    <Row>
                      <Col md={6}>
                        <div className="p-3">
                          ...
                          <span className="float-start mt-4">0</span> <span className="float-end  mt-4">100</span>
                          <Slider
                      ...
                      <Col md={6}>
                        <div className="p-3">
                          ...
                          <span className="float-start mt-4">30</span> <span className="float-end  mt-4">90</span>
                          <Slider
                    ...
                    <Row>
                      <Col md={6}>
                        <div className="p-3">
                          ...
                          <span className="float-start mt-4">100</span> <span className="float-end  mt-4">0</span>
                          <Slider
                            min={0}
                            max={100}
                    ...
                    <Row>
                      <Col md={6}>
                        <div className="p-3">
                          ...
                          <span className="float-start mt-4">1</span> <span className="float-end  mt-4">100</span>
                          <Slider
