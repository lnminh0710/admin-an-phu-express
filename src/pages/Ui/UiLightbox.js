...
import { Row, Col, Card, CardBody, CardText, Button, Modal, ModalHeader, ModalBody, Container, Form, Input, Label } from 'reactstrap';
        ...
        <div className="page-content">
          <Container fluid={true}>
            ...
            {this.state.isEffects ? (
              <Lightbox mainSrc={images[3]} enableZoom={false} onCloseRequest={() => this.setState({ isEffects: false })} />
            ) : null}
                    ...
                    <Row>
                      <Col xs={6}>
                        <div>
                          ...
                          <img onClick={() => this.setState({ isFits: true })} className="img-fluid" alt="Skote" src={img2} width="145" />
                        </div>
                      </Col>
                      <Col xs={6}>
                        <div>
                          ...
                          <CardText className="mt-2 mb-0 text-muted">No gaps, zoom animation, close icon in top-right corner.</CardText>
                        </div>
                      </Col>
                    </Row>
                  </CardBody>
                  ...
                  <CardBody>
                    ...
                    <div className="zoom-gallery">
                      <img
                        ...
                        onClick={() => this.setState({ isGalleryZoom: true, photoIndex: 2 })}
                        alt=""
                        width="275"
                      />
                      <img
                        src={img7}
                        className="float-start"
                        onClick={() => this.setState({ isGalleryZoom: true, photoIndex: 4 })}
                        alt=""
                        width="275"
                      />
                    </div>
              ...
              <Col xs={6}>
                ...
                <Card>
                  <CardBody>
                    ...
                    <div>
                      <Link onClick={() => this.setState({ isModal: !this.state.modal })} to="#" className="popup-form btn btn-primary">
                        Popup form
                      </Link>
                    </div>

                    <Modal size="xl" isOpen={this.state.isModal} centered={true} toggle={() => this.setState({ isModal: !this.state.isModal })}>
                      <ModalHeader toggle={() => this.setState({ isModal: !this.state.isModal })}>Form</ModalHeader>
                      <ModalBody>
                        <Form>
                          <Row>
                            <Col lg={4}>
