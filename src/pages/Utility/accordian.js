          ...
          <Link to="#" className="text-dark" onClick={this.t_col1} style={{ cursor: 'pointer' }}>
            <CardHeader id="gen-question-headingOne">
              <h5 className="font-size-14 m-0">
                <i className={this.state.col1 ? 'mdi mdi-chevron-up accor-arrow-icon' : 'mdi mdi-chevron-right accor-arrow-icon'}></i>{' '}
        ...
        <Card>
          <Link to="#" onClick={this.t_col2} style={{ cursor: 'pointer' }}>
            <CardHeader id="gen-question-headingTwo">
              <h5 className="font-size-14 m-0">
                <i className={this.state.col2 ? 'mdi mdi-chevron-up accor-arrow-icon' : 'mdi mdi-chevron-right accor-arrow-icon'}></i>{' '}
        ...
        <Card>
          <Link to="#" onClick={this.t_col3} style={{ cursor: 'pointer' }}>
            <CardHeader id="gen-question-headingThree">
              <h5 className="font-size-14 m-0">
                <i className={this.state.col3 ? 'mdi mdi-chevron-up accor-arrow-icon' : 'mdi mdi-chevron-right accor-arrow-icon'}></i>{' '}
        ...
        <Card>
          <Link to="#" onClick={this.t_col4} style={{ cursor: 'pointer' }}>
            <CardHeader id="gen-question-headingFour">
              <h5 className="font-size-14 m-0">
                <i className={this.state.col4 ? 'mdi mdi-chevron-up accor-arrow-icon' : 'mdi mdi-chevron-right accor-arrow-icon'}></i>
        ...
        <Card>
          <Link to="#" onClick={this.t_col5} style={{ cursor: 'pointer' }}>
            <CardHeader id="gen-question-headingFive">
              <h5 className="font-size-14 m-0">
                <i className={this.state.col5 ? 'mdi mdi-chevron-up accor-arrow-icon' : 'mdi mdi-chevron-right accor-arrow-icon'}></i>{' '}
