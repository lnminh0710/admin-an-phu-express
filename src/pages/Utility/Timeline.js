                      ...
                      <Card className="timeline-box">
                        <CardBody>
                          ...
                          <div className="text-muted">
                            <p className="mb-0">
                              It will be as simple as occidental in fact. To an english person, it will seem like simplified English, as a
                              skeptical friend
                            </p>
                          </div>
                        </CardBody>
                    ...
                    <div className="timeline-block">
                      <Card className="timeline-box">
                        <CardBody>
                          ...
                          <div className="text-muted">
                            <p>
                              The new common language will be more simple and regular than the existing European languages be as simple as
                              occidental
                            </p>
                          </div>
                    ...
                    <div className="timeline-block">
                      <Card className="timeline-box">
                        <CardBody>
                          ...
                          <div className="text-muted">
                            <p className="mb-0">
                              Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, ab illo
