                      ...
                      <Col lg={12}>
                        <div className="text-center">
                          ...
                          <p className="text-muted">
                            It will be as simple as in fact, it will be occidental. it will seem like simplified English, as a skeptical
                            Cambridge friend
                          </p>

                          <div>
                            <Button color="primary" type="button" className="mt-2 me-2 waves-effect waves-light">
                              Email Us
                            </Button>
                            <Button color="info" type="button" className=" mt-2 waves-effect waves-light ms-1">
                              Send us a tweet
                            </Button>
                          </div>
                        </div>
