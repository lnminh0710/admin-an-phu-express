                ...
                <Card>
                  <CardBody>
                    ...
                    <div id="world-map-markers" style={{ height: '420px' }}>
                      <WorldVectorMap value="world_mill" width="500" color="#d4dadd" />
                    </div>
                  </CardBody>
                </Card>
              </Col>
                ...
                <Card>
                  <CardBody>
                    ...
                    <div id="india-vectormap" style={{ height: '350px' }}>
                      <Vector value="europe_mill" width="500" color="rgb(98, 110, 212)" />
                    </div>
                  </CardBody>
                </Card>
              </Col>
                ...
                <Card>
                  <CardBody>
                    ...
                    <div id="australia-vectormap" style={{ height: '350px' }}>
                      <Vector value="au_mill" width="500" color="rgb(98, 110, 212)" />
                    </div>
                  </CardBody>
                </Card>
              </Col>
                ...
                <Card>
                  <CardBody>
                    ...
                    <div id="uk-vectormap" style={{ height: '350px' }}>
                      <Vector value="indonesia" width="500" color="rgb(98, 110, 212)" />
                    </div>
                  </CardBody>
                </Card>
              </Col>
