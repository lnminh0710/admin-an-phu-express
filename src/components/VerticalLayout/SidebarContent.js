          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/ecommerce-products">{this.props.t('Products')}</Link>
                </li>
                <li>
                  <Link to="/ecommerce-product-detail/1">{this.props.t('Product Detail')}</Link>
                </li>
                <li>
                  <Link to="/ecommerce-orders">{this.props.t('Orders')}</Link>
                </li>
                <li>
                  <Link to="/ecommerce-customers">{this.props.t('Customers')}</Link>
                </li>
                <li>
                  <Link to="/ecommerce-cart">{this.props.t('Cart')}</Link>
                </li>
                <li>
                  <Link to="/ecommerce-checkout">{this.props.t('Checkout')}</Link>
                </li>
                <li>
                  <Link to="/ecommerce-shops">{this.props.t('Shops')}</Link>
                </li>
                <li>
                  <Link to="/ecommerce-add-product">{this.props.t('Add Product')}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/ui-rangeslider">{this.props.t('Range Slider')}</Link>
                </li>
                <li>
                  <Link to="/ui-roundslider">{this.props.t('Round Slider')}</Link>
                </li>
                <li>
                  <Link to="/ui-session-timeout">{this.props.t('Session Timeout')}</Link>
                </li>
                <li>
                  <Link to="/ui-progressbars">{this.props.t('Progress Bars')}</Link>
                </li>
                <li>
                  <Link to="/ui-sweet-alert">{this.props.t('Sweet Alerts')}</Link>
                </li>
                <li>
                  <Link to="/ui-tabs-accordions">{this.props.t('Tabs & Accordions')}</Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/ui-notifications">{this.props.t('Notifications')}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/form-elements">{this.props.t('Form Elements')}</Link>
                </li>
                <li>
                  <Link to="/form-validation">{this.props.t('Form Validation')}</Link>
                </li>
                <li>
                  <Link to="/form-advanced">{this.props.t('Form Advanced Plugins')}</Link>
                </li>
                <li>
                  <Link to="/form-editors">{this.props.t('Form Editors')}</Link>
                </li>
                <li>
                  <Link to="/form-file-upload">{this.props.t('Form File Upload')}</Link>
                </li>
                <li>
                  <Link to="/form-xeditable">{this.props.t('Form X-editable')}</Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/datatable-table">{this.props.t('Data Tables')}</Link>
                </li>
                <li>
                  <Link to="/responsive-table">{this.props.t('Responsive Table')}</Link>
                </li>
                <li>
                  <Link to="/editable-table">{this.props.t('Editable Table')}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/material-design">{this.props.t('Material Design')}</Link>
                </li>
                <li>
                  <Link to="/dripicons">{this.props.t('Dripicons')}</Link>
                </li>
                <li>
                  <Link to="/font-awesome-5">{this.props.t('Font awesome 5')}</Link>
                </li>
              </ul>
            </li>
